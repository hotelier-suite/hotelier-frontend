...
function createEventCreationSchema(t: (key: string) => string) {
  return z
    .object({
      name: z
        .string()
      ...
      clientEmail: z.string().email(t("validationEmailInvalid")),
      ...
      venueId: z.string().min(1, t("validationVenueRequired")),
...
type EventCreationFormData = z.infer<
  ReturnType<typeof createEventCreationSchema>
>;
...
export function EventCreationDialog({
  ...
  const t = useTranslations("EventCreationDialog");
  const eventCreationSchema = createEventCreationSchema(t);
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                      ...
                      <SelectContent>
                        {venues
                          ...
                          .map((venue) => (
                            ...
                            >
                              {venue.name} - {t("capacity")}: {venue.capacity}{" "}
                              {t("people")}
                            </SelectItem>
                          ))}
                      </SelectContent>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("additionalDescription")}</FormLabel>
                  <FormControl>
                    <Textarea
