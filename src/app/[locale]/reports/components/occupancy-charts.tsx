...
export function OccupancyCharts({
  ...
  const t = useTranslations("OccupancyCharts");
  return (
    <div className="grid gap-4 md:grid-cols-2">
      <Card>
        <CardHeader>
          <CardTitle>{t("occupancyTrend")}</CardTitle>
          <CardDescription>{t("occupancyTrendDesc")}</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t("distributionByGuest")}</CardTitle>
          <CardDescription>{t("distributionByGuestDesc")}</CardDescription>
        </CardHeader>
        <CardContent>
          <ChartContainer config={chartConfig} className="h-[300px]">
            <PieChart>
