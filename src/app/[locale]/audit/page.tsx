  ...
  useEffect(() => {
    const loadAuditLogs = async () => {
      ...
      try {
        ...
        setError(t("errorLoadingAuditLogs"));
        setLogs([]);
        setTotal(0);
      } finally {
        setLoading(false);
  ...
  return (
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {t("showingXOfY", { showing: logs.length, total: total })}
            </p>
          </CardContent>
        </Card>
      ...
      <Tabs defaultValue="logs" className="space-y-4">
        <TabsList>
          <TabsTrigger value="logs">{t("auditRecords")}</TabsTrigger>
