...
export function Reservations({
  ...
  const handleUpdateStatus = async (
    ...
    try {
      ...
      toast("Status updated", {
        description: `Reservation #${id} → ${status}`,
      });
    } catch (error) {
  ...
  const handleAddReservation = async (formData: {
    ...
    try {
      ...
      toast.error("Error", { description: "Could not create reservation" });
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleUpdateReservation = async (
    ...
    try {
      ...
      toast("Success", { description: "Reservation updated successfully" });
    } catch (error) {
      console.error("Error updating reservation:", error);
      toast.error("Error", { description: "Could not update reservation" });
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleCheckout = async (id: number) => {
    try {
      ...
      toast("Checkout completed", {
        description:
          `Room ${updated.room?.number ?? updated.roomId} sent to housekeeping` +
          (dto.assignmentId ? ` (Assignment #${dto.assignmentId})` : "") +
          ". See in Housekeeping.",
      });
    } catch (error) {
      console.error("Error performing checkout:", error);
      toast.error("Error", {
        description: "Could not complete checkout",
      });
    } finally {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      setSelectedReservation(null);
      toast("Success", { description: "Reservation deleted successfully" });
    } catch (error) {
      console.error("Error deleting reservation:", error);
      toast.error("Error", { description: "Could not delete reservation" });
    } finally {
      setLoading(false);
    }
  };
